...
export const SPORT_THEMES: ThemeConfig[] = [
  { 
    ...
    icons: { main: Flame, secondary: Target, accent: Rocket, style: 'glow' },
    cardStyle: 'sharp',
    borderRadius: '0.5rem',
    buttonShape: 'sharp',
  ...
  { 
    ...
    icons: { main: Zap, secondary: Rocket, accent: Star, style: 'glow' },
    cardStyle: 'sharp',
    borderRadius: '0.5rem',
    buttonShape: 'sharp',
    glowIntensity: 'high',
  ...
  { 
    ...
    icons: { main: Sparkles, secondary: Rocket, accent: Star, style: 'glow' },
    cardStyle: 'beveled',
    borderRadius: '1rem',
    buttonShape: 'rounded',
    glowIntensity: 'high',
