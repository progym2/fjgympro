  ...
  return (
    <div className="flex flex-col items-center gap-2 animate-fade-in">
      <div className="flex items-center gap-1 bg-black/80 px-4 py-2 border-l-4 border-orange-500">
        ...
        <span className="text-3xl sm:text-4xl text-orange-500 font-bold animate-pulse">:</span>
        <span className="text-4xl sm:text-5xl font-bebas text-orange-400 tracking-widest">
          {minutes}
        </span>
    ...
    <div className="flex flex-col items-center gap-1 animate-fade-in">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center">
          ...
          <span className="text-4xl sm:text-5xl text-emerald-600 mx-1 animate-pulse">•</span>
  ...
  return (
    <div className="flex flex-col items-center animate-fade-in">
      <div className="flex items-center bg-black/90 px-4 py-2 border border-yellow-400/50 shadow-[0_0_20px_rgba(250,204,21,0.3)]">
        ...
        <span className="text-3xl text-yellow-400 mx-1 animate-pulse">:</span>
    ...
    <div className="flex flex-col items-center animate-fade-in">
      <div className="relative bg-black/80 rounded-lg px-5 py-3 border border-pink-500/50 shadow-[0_0_30px_rgba(236,72,153,0.4)]">
        <div className="flex items-center">
          ...
          <span className="text-3xl text-pink-500 mx-1 animate-pulse">:</span>
          <span 
            className="text-4xl sm:text-5xl font-bebas text-pink-400"
            style={{ textShadow: '0 0 20px rgba(236,72,153,0.8)' }}
          >
...
const GoldClock: React.FC<{ time: Date }> = memo(({ time }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-2 animate-fade-in">
      <div className="relative bg-gradient-to-b from-amber-900/40 to-yellow-900/30 backdrop-blur-sm rounded-xl px-6 py-3 border border-yellow-500/40 overflow-hidden">
        <div className="flex items-center gap-3">
...
// ============ AMOLED CLOCK - Minimal Battery Saver ============
  ...
  return (
    <div className="flex flex-col items-center gap-2 animate-fade-in">
      <div className="flex items-center gap-1">
        <span className="text-5xl sm:text-6xl font-bebas text-gray-300 tracking-widest">
          {hours}
        </span>
      ...
      <span className="text-xs text-gray-500/70 uppercase tracking-wider">{date}</span>
    </div>
  );
});
